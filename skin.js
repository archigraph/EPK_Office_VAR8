...
// Generated 2025-02-19T10:55:54

function pano2vrSkin(player,base) {
	player.addVariable('vis_auto_hide_controller', 2, true, { ignoreInState: 0  });
	player.addVariable('opt_thumbnail_menu_tooltip', 2, true, { ignoreInState: 0  });
	...
	player.addVariable('ht_ani', 2, false, { ignoreInState: 1  });
	var me=this;
	var skin=this;
	var flag=false;
	...
	this.addSkin=function() {
		...
		me._map.onmouseenter=function (e) {
			me.elementMouseOver['map']=true;
			me._tt_map.logicBlock_visible();
		}
		me._map.onmouseleave=function (e) {
		...
		me._tt_map.logicBlock_position = function() {
			...
			if (me._tt_map.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._tt_map.style.transition='left 0s, bottom 0s';
				if (me._tt_map.ggCurrentLogicStatePosition == 0) {
					me._tt_map.style.left = 'calc(50% - (0px / 2))';
					me._tt_map.style.bottom='-25px';
				}
				else {
					me._tt_map.style.left='calc(50% - ((0px + 0px) / 2) + 4px)';
		...
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			'';
		...
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
		...
		me._tt_gyro.logicBlock_position = function() {
			...
			if (me._tt_gyro.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._tt_gyro.style.transition='left 0s, bottom 0s';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		me._text_1.ggUpdateText=function() {
			var params = [];
			var hs = player._("Created by ARCHIGRAPH", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
	...
	function SkinElement_map_blue_pin_Class(parentScope,ggParent) {
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'LjYsMCw2MC44LDI3LjIsNjAuOCw2MC44UzIxNi41LDI0OCwxODIuOSwyNDhDMTQ5LjQsMjQ4LDEyMi4yLDIyMC44LDEyMi4yLDE4Ny4yeiIgZmlsbD0iIzAwQUVFRiIvPgogPC9nPgo8L3N2Zz4K';
		...
		hs+='bottom : 353px;';
		hs+='height : 32px;';
		hs+='left : calc(50% - ((32px + 0px) / 2) - 159px);';
		hs+='position : absolute;';
		hs+='visibility : inherit;';
		hs+='width : 32px;';
		hs+='pointer-events:auto;';
	...
	function SkinHotspotClass_hotspot_1(parentScope,hotspot) {
		...
		hs+='cursor : pointer;';
		hs+='height : 32px;';
		hs+='left : calc(50% - ((32px + 0px) / 2) - 168px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((32px + 0px) / 2) - 243px);';
		hs+='visibility : inherit;';
		hs+='width : 32px;';
		hs+='pointer-events:none;';
		el.setAttribute('style',hs);
		...
		me._rectangle_1.logicBlock_scaling = function() {
			...
			if (me._rectangle_1.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				me._rectangle_1.style.transition='transform 1000ms ease 0ms, opacity 1000ms ease 0ms';
